...
var routes = [
    ...
    {
        path: 'otpverify',
        loadChildren: function () { return __webpack_require__.e(/*! import() | otpverify-otpverify-module */ "otpverify-otpverify-module").then(__webpack_require__.bind(null, /*! ./otpverify/otpverify.module */ "./src/app/pages/login/otpverify/otpverify.module.ts")).then(function (m) { return m.OtpverifyPageModule; }); }
    }
];
...
var LoginPage = /** @class */ (function (_super) {
    ...
    function LoginPage(navCtrl, loadingCtrl, alertCtrl, platform, events, menuCtrl, toastCtrl, route, formBuilder, loading, injector) {
    ...
    LoginPage.prototype.handleApiResponse = function (data) {
    ...
    LoginPage.prototype.handleApiResponseError = function (data) {
