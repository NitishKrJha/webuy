...
var LoginPage = /** @class */ (function () {
    function LoginPage(navCtrl, loadingCtrl, alertCtrl, platform, events) {
    ...
    LoginPage.prototype.sendOtp = function () {
        this.navCtrl.navigateRoot('/login/otpverify');
    };
