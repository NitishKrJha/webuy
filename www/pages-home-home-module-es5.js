...
var HomePage = /** @class */ (function (_super) {
    ...
    HomePage.prototype.viewPr = function (id) {
        if (id === void 0) { id = ''; }
        var navigationExtras = {
            queryParams: {
                prId: id
