...
/* harmony import */ var _addeditaddress_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./addeditaddress.page */ "./src/app/pages/addeditaddress/addeditaddress.page.ts");
...
var AddeditaddressPageModule = /** @class */ (function () {
    ...
    AddeditaddressPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: [_addeditaddress_page__WEBPACK_IMPORTED_MODULE_6__["AddeditaddressPage"]]
        })
...
var AddeditaddressPage = /** @class */ (function (_super) {
    ...
    function AddeditaddressPage(navCtrl, loadingCtrl, alertCtrl, platform, events, menuCtrl, toastCtrl, route, formBuilder, loading, injector) {
        ...
        _this.base.shared.Lstorage.fetchData('customerId').then(function (data) {
            if (data) {
