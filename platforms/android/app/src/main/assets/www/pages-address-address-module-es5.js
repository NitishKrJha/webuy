...
var AddressPageRoutingModule = /** @class */ (function () {
    function AddressPageRoutingModule() {
    }
...
var AddressPage = /** @class */ (function (_super) {
    ...
    function AddressPage(navCtrl, loadingCtrl, alertCtrl, platform, events, menuCtrl, toastCtrl, route, loading, injector) {
    ...
    AddressPage.prototype.handleApiResponse = function (data) {
    ...
    AddressPage.prototype.handleApiResponseError = function (data) {
        this.loading.dismiss();
    ...
    AddressPage.prototype.delAddrees = function (id) {
    ...
    AddressPage.prototype.setDefaultAddrees = function (id) {
        this.loading.present();
