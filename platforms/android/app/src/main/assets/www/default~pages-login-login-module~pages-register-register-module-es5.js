...
var FootersComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](FootersComponent, _super);
    function FootersComponent(navCtrl, router, loading, injector) {
    ...
    FootersComponent.prototype.ngAfterViewInit = function () {
        this.text = this.textToUse;
    };
    FootersComponent.prototype.goProfile = function () {
        this.router.navigate(['/myprofile']);
    };
    FootersComponent.prototype.goHome = function () {
        this.router.navigate(['/home']);
    };
    FootersComponent.prototype.logout = function () {
        var _this = this;
        this.loading.present();
        this.base.shared.Lstorage.fetchData('token').then(function (data) {
            _this.base.api.logout({ token: data });
        });
    };
    FootersComponent.prototype.goLogin = function () {
        this.router.navigate(['/login']);
    };
    FootersComponent.ctorParameters = function () { return [
...
var HeadersComponent = /** @class */ (function () {
    function HeadersComponent(navCtrl) {
    ...
    HeadersComponent.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])('myText'),
...
//# sourceMappingURL=default~pages-login-login-module~pages-register-register-module-es5.js.map